...
export const hero = {
  ...
  content:
    "Building impactful products and solving real-world problems through code. Focused on backend development & system design. [[YEARS_OF_EXP]] of exp.",
};
...
export const socials = [
  ...
  {
    name: "LinkedIn",
    url: "https://linkedin.com/in/gajanansr",
  },
  {
    name: "GitHub",
